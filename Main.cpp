...
#define PDDOC_RELEASE "AquaDoc"
#define PDDOC_VERSION "2.0.0"
...
{
	return string(".doc-section { background-color: #eeeeee; }\r\n") +
		string(".doc-section-header { background-color: #DDDDDD; font-size: 2em; }\r\n") +
		string(".doc-section-orden { font-style: bold; background-color: blue; }\r\n") +
		string(".doc-section-type { font-style: bold; background-color: blue; }\r\n") +
		string(".doc-section-ins { font-style: italic; background-color: blue; }\r\n") +
		string(".doc-section-attr { font-style: bold; background-color: green; }\r\n") +
		string(".doc-section-here { font-style: italic; background-color: green; }\r\n") +
		string(".doc-section-des-breve { }\r\n") +
		string(".doc-section-arg-name { font-style: italic; }\r\n") +
		string(".doc-section-dev-des { font-style: italic; }\r\n") +
		string(".doc-section-arg-des { }\r\n") +
		string(".doc-section-arg-decl { font-style: italic; background-color: blue; }\r\n") +
		string(".docs { background-color: #DDDDDD; font-style: italic; }\r\n") +
		string("body { background-color: #DDDDDD; font-family: sans-serif; font-size: 16px; color: black; }\r\n") +
		string(".doc-index { background-color: #eeeeee; }\r\n") +
		string(".doc-head-index { background-color: #DDDDDD; font-size: 2em; }\r\n") +
		string(".doc-ul-index { list-style-type: none; }\r\n") +
		string(".doc-section-arg-ttl { color: #b33b00; }\r\n") +
		string(".doc-section-dev-ttl { color: #b33b00; }\r\n") +
		string(".doc-section-code-block { display: block; }\r\n") +
		string(".doc-li-index { }\r\n") +
		string(".block { display: block; border: 1px solid black; width: 90%; }\r\n") +
		string(".doc-section-error-ttl { color: #b33b00; }\r\n") +
		string(".doc-section-error-secure { color: green; }\r\n") +
		string(".doc-section-error-insecure { color: #800800; }\r\n") +
		string(".doc-section-error-inestable { color: red; }\r\n") +
		string(".doc-section-error-optional { color: #800800; }\r\n");
}
...
string Documentar(istream& in,ostream& out,vector<string>& index)
{
	...
	while(line != "DOCUMENTA]")
	{
		...
		{
			out << "<h3 class=\"doc-section-dev-ttl\">Devuelve:</h3> <span class=\"doc-section-dev-des\">";
			out << linea(in,false) << "</span><br/>" << endl;
		}
		else if((line == "@file")||(line == "@section"))
		{
			isFile = true;
			out << "<h2 class=\"doc-section-header\">" << linea(in,false);
			out << "</h2>" << endl;
		}
		else if(line == "@nsection")
		{
			...
			ttl = linea(in,false);
			out << "<a name=\"" << ref;
			out << "\"></a><h2 class=\"doc-section-header\">" << ttl;
			out << "</h2>" << endl;
		...
		else if(line == "@argyo")
		{
			...
			if(!argCnt)
			{
				out << "<h3 class=\"doc-section-arg-ttl\">Argumentos</h3>" << endl;
				argCnt = true;
			}
		...
		else if(line == "@errors")
		{
			string val;
			in >> val;
			out << "<h3 class=\"doc-section-error-ttl\">Garantia de error: </h3>";
			if(val == "Active")
			{
	...
	if(((line == "adquirir")||(line == "puntero"))||(line == "funcion"))
	{
		...
		os << "<h2 class=\"doc-section-header\">" << line << " " << A << "</h2>" << endl;
		os << "<code class=\"doc-section-code-block\"><pre>";
		os << "<span class=\"doc-section-orden\">" << line << " </span>" << "<span class=\"doc-section-ins\">" << A << " </span> ";
		if(line == "funcion")
		{
			for(int i = 0; i < args.size(); i += 1)
			{
				os << "<span class=\"doc-section-arg-decl\">" << args[i] << " </span> ";
			}
		}
		os << "</pre></code>";
		os << "<br/>" << endl;
	...
	if((line == "instancia")||(line == "Importar.Tipos.Instancia"))
	{
		...
		os << "<h2 class=\"doc-section-header\"> instancia " << B << " " << A << "</h2>" << endl;
		os << "<code class=\"doc-section-code-block\"><pre>";
		os << "<span class=\"doc-section-orden\">" << line << " </span>" << "<span class=\"doc-section-type\">" << B << " </span>" << "<span class=\"doc-section-ins\">" << A << "</span>";
		os << "</pre></code>";
	}
	if((line == "clase")||(line == "Importar.Tipos.Estructura"))
	{
		...
		os << "<h2 class=\"doc-section-header\">clase " << B << "</h2>" << endl;
		os << "<code class=\"doc-section-code-block\"><pre>";
		os << "<span class=\"doc-section-orden\">" << line << " </span>" << "<span class=\"doc-section-ins\">" << B << "</span>" << endl;
		in >> A;
		while((A != "#(Final).")&&(A != "finclase"))
		{
			os << "&nbsp;&nbsp;&nbsp;&nbsp;<span class=\"doc-section-attr\">" << A << "</span>" << endl;
			in >> A;
		}
		os << "<span class=\"doc-section-orden\">finclase</span>";
		os << "</pre></code>";
		in >> B;
		if(B == "heredar")
		{
...
int main (int argc, char const* argv[])
{
	...
	if(argc == 2)
	{
		...
		{
			cout << "PDDoc release " << PDDOC_RELEASE << " version " << PDDOC_VERSION << endl;
			return 0;
		}
		return 1;
	}
	...
	if(index.size() > 0)
	{
		...
		out << "<h2 class=\"doc-head-index\">Indice</h2>" << endl;
